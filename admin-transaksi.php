...
if (!empty($searchDeskripsi)) {
    $conditions[] = "deskripsi LIKE ?";
    $params[] = '%' . $searchDeskripsi . '%';
    $types .= 's';
}
...
function buildUrl($newParams = []) {
    global $filterTanggalDari, $filterTanggalSampai, $filterKategori, $searchDeskripsi, $sortBy, $sortOrder, $page;
    
    $params = [
        'tanggal_dari' => $filterTanggalDari,
        'tanggal_sampai' => $filterTanggalSampai,
        'kategori' => $filterKategori,
        'search' => $searchDeskripsi,
        'sort_by' => $sortBy,
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form method="GET" action="" class="row g-3">
            <div class="col-md-12">
                <label class="form-label"><i class="bi bi-search"></i> Cari Deskripsi</label>
                <input type="text" name="search" class="form-control" placeholder="Masukkan kata kunci deskripsi..."
                    value="<?php echo htmlspecialchars($searchDeskripsi); ?>">
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <select name="kategori" class="form-control">
                    ...
                    <option value="pemasukan" <?php echo $filterKategori === 'pemasukan' ? 'selected' : ''; ?>>Pemasukan
                    </option>
                    <option value="pengeluaran" <?php echo $filterKategori === 'pengeluaran' ? 'selected' : ''; ?>>
                        Pengeluaran
                    </option>
                </select>
            </div>
                    ...
                    <tr>
                        <th>
                            <a href="<?php echo buildUrl(['sort_by' => 'id', 'sort_order' => getNextSortOrder('id'), 'page' => 1]); ?>"
                                ...
                                ID
                                <i class="bi <?php echo getSortIcon('id'); ?>" style="font-size: 0.875rem;"></i>
                            </a>
                        </th>
                        <th>
                            <a href="<?php echo buildUrl(['sort_by' => 'tanggal', 'sort_order' => getNextSortOrder('tanggal'), 'page' => 1]); ?>"
                                ...
                                Tanggal
                                <i class="bi <?php echo getSortIcon('tanggal'); ?>" style="font-size: 0.875rem;"></i>
                            </a>
                        </th>
                        <th>
                            <a href="<?php echo buildUrl(['sort_by' => 'deskripsi', 'sort_order' => getNextSortOrder('deskripsi'), 'page' => 1]); ?>"
                                ...
                                Deskripsi
                                <i class="bi <?php echo getSortIcon('deskripsi'); ?>" style="font-size: 0.875rem;"></i>
                            </a>
                        </th>
                        <th>
                            <a href="<?php echo buildUrl(['sort_by' => 'kategori', 'sort_order' => getNextSortOrder('kategori'), 'page' => 1]); ?>"
                                ...
                                Kategori
                                <i class="bi <?php echo getSortIcon('kategori'); ?>" style="font-size: 0.875rem;"></i>
                            </a>
                        </th>
                        <th>
                            <a href="<?php echo buildUrl(['sort_by' => 'nominal', 'sort_order' => getNextSortOrder('nominal'), 'page' => 1]); ?>"
                                ...
                                Nominal
                                <i class="bi <?php echo getSortIcon('nominal'); ?>" style="font-size: 0.875rem;"></i>
                            </a>
                        </th>
            ...
            <nav>
                <ul class="pagination mb-0">
                    ...
                    <li class="page-item <?php echo $page <= 1 ? 'disabled' : ''; ?>">
                        <a class="page-link" href="<?php echo buildUrl(['page' => $page - 1]); ?>">Sebelumnya</a>
                    </li>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="border-top: none;">
                        ...
                        <form id="formDeleteTransaksi" action="admin-transaksi-actions.php" method="POST"
                            class="d-inline">
